 ...
 * /users/{id}:
 *   put:
 *     summary: Update user profile (Users can only update their own profile)
 *     tags: [Users]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *                 description: Only provide if changing password
 *     responses:
 *       200:
 ...
 * /users/{id}:
 *   delete:
 *     summary: Delete user account (Be very careful - this is permanent!)
 *     tags: [Users]
 *     security:
 *       - cookieAuth: []
 *     parameters:
